...
export const OrderCategorySchema = z
    .object({
        id: z.number().int(),
...
export const CreateOrderCategorySchema = OrderCategorySchema
export const UpdateOrderCategorySchema = OrderCategorySchema.partial()

export type OrderCategorySchema = z.infer<typeof OrderCategorySchema>

export const OrderCategoryQuerySchema = z
    .object({
        id: z.number().int(),
...
export type OrderCategoryQuerySchema = z.infer<typeof OrderCategoryQuerySchema>
